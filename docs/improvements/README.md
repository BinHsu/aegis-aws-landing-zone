...
| [009](009-grafana-sso-integration.md) | Grafana SSO integration (disable local admin) | Auth-model consistency, operator identity attribution | N/A | **Obsoleted 2026-04-21** by [ADR-022](../decisions/022-observability-backend-grafana-cloud.md) — Grafana Cloud has native Google OAuth; SAML via AWS IAM Identity Center is a Pro-tier upgrade path per ADR-021 rung transitions |
