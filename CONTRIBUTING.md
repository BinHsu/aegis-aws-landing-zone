...
- [#54 — Platform surface contract](https://github.com/BinHsu/aegis-landing-zone-aws/issues/54) (this repo)
...
1. Update the [#54 issue body](https://github.com/BinHsu/aegis-landing-zone-aws/issues/54) in the same PR to reflect the new state.
